...
export interface Record {
    ...
    annotator_pertinencia?: string;
    annotator_pertinencia_reason?: string;
    annotator_postura?: string;
    annotator_postura_reason?: string;
    annotator_topic?: string;
    annotator_topic_reason?: string;
    annotator_sentiment?: number;
    annotator_sentiment_reason?: string;
    annotator_lang?: string;
    annotator_lang_reason?: string;
    annotator_world_continent?: string;
    annotator_world_continent_reason?: string;
    annotator_world_country?: string;
    annotator_world_country_reason?: string;
    annotator_world_region?: string;
    annotator_world_region_reason?: string;
    annotator_world_city?: string;
    annotator_world_city_reason?: string;
    annotator_legitimacion?: number;
    annotator_legitimacion_reason?: string;
    annotator_efectividad?: number;
    annotator_efectividad_reason?: string;
    annotator_justicia_equidad?: number;
