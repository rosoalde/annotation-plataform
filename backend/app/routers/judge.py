...
async def judge_records(
    ...
    for rec in records:
        ...
        rec_out = RecordOut(
            ...
            postura=rec.postura, justif_postura=rec.justif_postura,
    ...
    for rec_id, rec in all_records.items():
        ...
        if mode in ("judge", "all"):
            ...
            row = {
                ...
                "postura_final":          field_final["postura"],
                ...
                "judge_postura_reason":          field_reasons["postura"],
                ...
                "judge_postura_source":          field_sources["postura"],
